    ...
    <footer className='bg-gray-900 text-gray-200 py-10'>
      <div className='max-w-7xl mx-auto px-4 md:flex md:justify-between'>
        ...
        <div className='mb-6 md:mb-0'>
            ...
            <p className='mt-2 text-sm'>123 Electronics St,, NY 10001</p>
            <p className='text-sm'>Email: sangee@Zaptro.com</p>
            <p className='text-sm'>Phone: 8787756434</p>
        </div>
      ...
      <div className='mt-8 border-t border-gray-700 pt-6 text-center text-sm'>
        <p>&copy; {new Date().getFullYear()} <span className='text-red-500'>Sangee</span>. All rights reserved</p>
      </div>
    </footer>
  )
}
